...
jQuery(function ($) {
	...
	$(window).scroll(function () {
		...
		var widget = $('.wromo-body .side-widget');
...
jQuery(function ($) {
	...
	// Slider
	$('.wromo-section .slider').each(function () {
	...
	// Thumbnail Slider
	const ThumbnailSliderControl = new Swiper('.wromo-section .thumbnail-slider .thumbnail-slider-control', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		breakpoints: {
	...
	const ThumbnailSlider = new Swiper('.wromo-section .thumbnail-slider .thumbnail-slider-items', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
jQuery(function ($) {
	...
	var section = $('.wromo-section .shuffle');
...
jQuery(function ($) {
	$('.wromo-section .gallery').lightGallery({
		selector: '.wromo-section .gallery .lightbox-link:not(.prevent)',
		thumbnail: false,
		share: false,
		download: false
	})
